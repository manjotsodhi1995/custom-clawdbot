...
const BLACKBOX_REMOTE_CODE_DEFAULT_COST = {
  input: 0,
  output: 0,
  cacheRead: 0,
  cacheWrite: 0,
...
function buildBlackboxRemoteCodeProvider(): ProviderConfig {
  return {
    baseUrl: BLACKBOX_REMOTE_CODE_BASE_URL,
    api: "openai-completions",
    models: [
      {
        id: BLACKBOX_REMOTE_CODE_DEFAULT_MODEL_ID,
        name: "Blackbox Remote-Code",
        reasoning: false,
        input: ["text"],
        cost: BLACKBOX_REMOTE_CODE_DEFAULT_COST,
        contextWindow: BLACKBOX_REMOTE_CODE_DEFAULT_CONTEXT_WINDOW,
        maxTokens: BLACKBOX_REMOTE_CODE_DEFAULT_MAX_TOKENS,
      },
    ],
  };
}
...
export async function resolveImplicitProviders(params: {
  ...
  // Blackbox Remote-Code provider - always available (no API key required)
  providers["blackbox-remote-code"] = buildBlackboxRemoteCodeProvider();
