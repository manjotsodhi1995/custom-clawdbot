...
const AUTH_CHOICE_GROUP_DEFS: {
  ...
  {
    value: "blackbox-remote-code",
    label: "Blackbox Remote-Code",
    hint: "No auth required - enables @remote-code/ commands",
    choices: ["blackbox-remote-code"],
  },
];
...
export function buildAuthChoiceOptions(params: {
  ...
  options.push({
    value: "blackbox-remote-code",
    label: "Blackbox Remote-Code",
    hint: "No auth required - enables @remote-code/ commands in chat",
  });
